			...
			<li>
	            <div class="newscss_ctn">
	                ...
	                <div class="newscss_top">
	                    ...
	                    <div class="newscss_tle"><a target="_blank" href="<?php echo $gourl; ?>"><?php echo ($num++).'.'.$row['title']; ?></a></div>
	                    <div class="newscss_other"><?php echo GetDateTime($row['posttime']).' '.$row['hits'].'次阅读  作者:'.$row['author']; ?></div>
	                </div>
	            	<div class="newscss_txt"><a target="_blank" href="<?php echo $gourl; ?>"><?php echo infoList(80,$row['description']) ?></a></div>
	            </div>
