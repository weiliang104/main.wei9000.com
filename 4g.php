...
{
	require_once(PHPMYWIND_TEMP.'/default/mobile/about.php');
	exit();
}

else if($m == 'activity')
{
	require_once(PHPMYWIND_TEMP.'/default/mobile/activity.php');
	exit();
}

else if($m == 'product')
{
	require_once(PHPMYWIND_TEMP.'/default/mobile/product.php');
	exit();
}

else if($m == 'tiyan')
{
	require_once(PHPMYWIND_TEMP.'/default/mobile/tiyan.php');
	exit();
}
...
{
	require_once(PHPMYWIND_TEMP.'/default/mobile/chat.php');
	exit();
}
